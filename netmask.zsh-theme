...
# colors: main -- ip only
PROMPT=$'%{$fg_bold[blue]%}╭─[%{$fg[cyan]%}$(get_ip_address)%{$reset_color%}%{$fg_bold[blue]%}]%{$reset_color%} %{$fg[cyan]%}%~ %{$fg_bold[green]%}$(git_prompt_info)$(git_prompt_status)$(hg_prompt_info)%{$reset_color%}
%{$fg_bold[blue]%}╰─$(get_venv_info)>%{$reset_color%} '

# colors: breeze -- ip only
# PROMPT=$'%{$fg_bold[blue]%}╭─[%{$fg_bold[green]%}$(get_ip_address)%{$reset_color%}%{$fg_bold[blue]%}]%{$reset_color%} %{$fg[blue]%}%~ %{$fg_bold[green]%}$(git_prompt_info)$(git_prompt_status)$(hg_prompt_info)%{$reset_color%}
# %{$fg_bold[blue]%}╰─$(get_venv_info)>%{$reset_color%} '

# colors: breeze -- user@host with ip 
# PROMPT=$'%{$fg_bold[blue]%}╭─[%{$fg_bold[green]%}%n%b%{$fg[black]%}@%{$fg[cyan]%}%m%{$fg_bold[cyan]%}$(get_ip_address_alternate)%{$reset_color%}%{$fg_bold[blue]%}]%{$reset_color%} %{$fg[blue]%}%~ %{$fg_bold[green]%}$(git_prompt_info)$(git_prompt_status)$(hg_prompt_info)%{$reset_color%}
# %{$fg_bold[blue]%}╰─$(get_venv_info)>%{$reset_color%} '
